-- Track how many units of each sale line were sold inside a promotional package,
-- so the report can split promotional vs. regular units per product.
alter table public.sale_items
  add column if not exists promo_quantity integer not null default 0;
