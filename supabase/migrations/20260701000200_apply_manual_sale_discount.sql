-- Apply an optional manual discount to the final sale totals.
...
begin
  ...
  manual_discount_amount := greatest(
    0,
  ...
  manual_discount_amount := least(manual_discount_amount, v_gross_total);
  v_gross_total := v_gross_total - manual_discount_amount;
  v_profit_total := v_profit_total - manual_discount_amount;
